...
<div class="span9">
 ...
 <h2>Управление своим аккаунтом</h2>
...
<br>
  <div class="well">
   		...
   		<div class="row-fluid">
   			<div class="span6">
   			<form:hidden path="email" value="${pageContext.request.userPrincipal.name}"/>
   			<form:hidden path="repeatEmail" value="${pageContext.request.userPrincipal.name}"/>
